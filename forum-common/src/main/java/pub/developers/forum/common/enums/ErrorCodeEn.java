...
//    COMMON_START_TIME_AFTER_END(505, "开始时间不能大于结束时间"),
    ...
    DOMAIN_NOT_EXIST(7999, "不存在的音乐类型"),
    DOMAIN_TYPE_NOT_EXIST(7998, "音乐类型不存在"),
    ...
    ARTICLE_TYPE_IS_EXIST(5999, "帖子类型已存在"),
    ARTICLE_NOT_EXIST(5998, "帖子不存在"),
    ARTICLE_IN_AUDIT_PROCESS(5997, "帖子审核中"),

    FAQ_NOT_EXIST(4999, "贴子不存在"),
    FAQ_IN_AUDIT_PROCESS(4998, "帖子审核中"),
